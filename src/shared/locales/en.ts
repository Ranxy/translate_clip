...
export const en: LocaleResource = {
  ...
  overlay: {
    ...
    emptyTitleShort: 'Copy to translate',
    ...
    actionTranslateShort: 'Translate',
  ...
  settings: {
    ...
    general: {
      ...
      uiLanguageSystemResolved: 'Follow system (currently {{language}})',
      behavior: 'Behaviour',
  ...
  onboarding: {
    ...
    uiLanguage: 'Interface language',
    uiLanguageHint: 'Follows your system language by default; you can change it later in Settings.',
